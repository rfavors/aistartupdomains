    ...
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-1 animate-fade-in">
            <Link to="/" className="group flex items-center space-x-3 mb-6 hover-glow">
              <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-blue-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-600 transition-all duration-300 transform hover:scale-110 hover-glow">
              ...
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-500 transition-all duration-300 transform hover:scale-110 hover-glow">
        ...
        <div className="mt-16 mb-12">
          <div className="bg-gradient-to-r from-primary-600/20 to-blue-600/20 rounded-3xl p-8 glass-effect border border-primary-500/20">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                ...
                />
                <button className="px-6 py-3 bg-gradient-to-r from-primary-600 to-blue-600 text-white rounded-xl font-medium hover:from-primary-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 hover-glow">
                  Subscribe
                </button>
              </div>
            </div>
